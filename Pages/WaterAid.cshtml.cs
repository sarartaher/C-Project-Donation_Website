...
{
    public class WaterAidModel : PageModel
    {
        ...
        public IActionResult OnPost()
        {
            ...
            try
            {
                ...
                // Redirect to Donation page with FundraiserID=5 (Water Aid Project) and amount
                return RedirectToPage("/Donation", new { fundraiserId = 5, amount = Amount });
            }
            catch (Exception ex)
            {
