...
{
    public class GazaModel : PageModel
    {
        ...
        public IActionResult OnPost()
        {
            ...
            try
            {
                ...
                // Redirect to Donation page with FundraiserID=1 (Gaza Relief) and amount
                return RedirectToPage("/Donation", new { fundraiserId = 1, amount = Amount });
            }
            catch (Exception ex)
            {
