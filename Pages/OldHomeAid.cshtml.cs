...
{
    public class OldHomeAidModel : PageModel
    {
        ...
        public IActionResult OnPost()
        {
            ...
            try
            {
                ...
                // Redirect to Donation page with FundraiserID=4 (Old Age Home Support) and amount
                return RedirectToPage("/Donation", new { fundraiserId = 4, amount = Amount });
            }
            catch (Exception ex)
            {
